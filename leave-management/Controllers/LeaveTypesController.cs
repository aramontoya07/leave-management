...

    {
        ...
        public async Task<ActionResult> Create(LeaveTypeVM model)
        {
            try
            {
                ...
                var isSuccess =await _repo.Create(leaveType); //recordar que devuelve booleano
        ...
        public async Task<ActionResult> Edit(int id)
        {
            ...
            var leavetype = await _repo.FindById(id); //una vez que encuentro el registro pedido, lo mapeo y retorno el vm
            var model = _mapper.Map<LeaveTypeVM>(leavetype);
            return View(model);
        }
